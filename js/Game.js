class Game {
  ...
  start() {
    ...
    car1.scale = 0.07;
    car1.addImage("TristezaConsumiu",blastImage);

    car2 = createSprite(width / 2 + 100, height - 100);
    car2.addImage("car2", car2_img);
    car2.scale = 0.07;
    car2.addImage("TristezaConsumiu",blastImage);
  ...
  play() {
    ...
    if (allPlayers !== undefined) {
      ...
      for (var plr in allPlayers) {
        ...
        var restoDeFelicidade = allPlayers[plr].life;
        if(restoDeFelicidade <= 0){
          cars[index-1].changeImage("TristezaConsumiu");
        ...
        if (index === player.index) {
          ...
          this.verificaoDeTristeza(index);
          if(player.life <= 0){
            this.playerMoving = false;
            this.CachorroTriste = true;
          }
  ...
  console.log("Parabens,você não deixou a tristeza lhe consumir");
  }
}
